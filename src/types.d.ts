...
type DLiveMuteOnCommand = {
	command: 'mute_on'
	params: { channelType: ChannelType; channelNo: number }
}
...
type DLiveFaderLevelCommand = {
	command: 'fader_level'
	params: { channelType: ChannelType; channelNo: number; level: number }
}
...
type DLiveDcaAssignmentOnCommand = {
	...
	params: { channelType: ChannelType; channelNo: number; dcaNo: number }
}
...
type DLiveMuteGroupAssignmentOnCommand = {
	...
	params: { channelType: ChannelType; channelNo: number; muteGroupNo: number }
}
...
type DLiveSetSocketPreampGainCommand = {
	...
	params: { socketType: SocketType; socketNo: number; gain: number }
}

type DLiveSetSocketPreampPadCommand = {
	command: 'set_socket_preamp_pad'
	params: { socketType: SocketType; socketNo: number; shouldEnable: boolean }
}
...
type DLiveHPFFrequencyCommand = {
	...
	params: { channelNo: number; frequency: number }
}
